...
namespace DotwCalls\FirstCall;
 
//$message="PSFILTER |164|prod|1|Y|14,24,34,44,54,64|||||1~5#5#10~N~N,2~2#3#6~N~N||\r\n";
class Input {
 
    public $customerId = 551665;//1534906; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1552640400;//1553558400; //Mandatory
    public $travelTo = 1553644800;//Mandatory
    public $bookingDateTime = 1552694400;//1529331799; //1528974697;//Mandatory
}
