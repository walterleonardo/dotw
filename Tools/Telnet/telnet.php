 ...
 */
 function Connect($server,$user,$pass,$port,$string) {
 $rv=0;
 ...
 case 4: echo '<br />[PHP Telnet] <a href="http://www.geckotribe.com/php-telnet/errors/php-version.php">Connect failed: Your servers PHP version is too low for PHP Telnet</a><br />'; break;
 }
 }
}
