...
/*
 * DEMO SIMULATION SERVER only check space and key and send ASNWERs for any request.
 * This version include the posibility to run from console o with a GET of values of server and port to have multiples
 * instances.
 * 
...
class Servers {
    ...
    public function tcpserver($address, $portServer) {
        $max_clients = 5;
        $preguntas = 0;
        $respuestas = 0;
        $limpieza = 0;
