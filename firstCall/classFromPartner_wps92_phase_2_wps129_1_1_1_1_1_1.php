...
class Input {
    ...
    public $customerId = 1591615;//1534906; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    ...
    public $hotelIds = array (163576/*0 => 820415,*/); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1568419200;//1553558400; //Mandatory
    public $travelTo = 1568419200;//Mandatory
    public $bookingDateTime = 1557240736;//1529331799; //1528974697;//Mandatory
}
