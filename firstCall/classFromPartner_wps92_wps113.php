...
class Input {
    ...
    public $hotelIds = array (/*0 => 820415,*/ 0 => 23734); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1509840000; //Mandatory
    public $travelTo = 1509840000;//Mandatory
    public $bookingDateTime = 1540468890;//1529331799; //1528974697;//Mandatory
}
