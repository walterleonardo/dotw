...
class Input {
    ...
    public $customerId = 1259355;//1534906; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    ...
    public $hotelIds = array (/*0 => 820415,*/); //array(int)
    //country 143 and city 85516
    public $city = 80956; //364 dubai //12764; //7674; //integer 7674 // 13474 Zamora //12624 BUCHARESt //14 kuwait
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1556928000;//1553558400; //Mandatory
    public $travelTo = 1556928000;//Mandatory
    public $bookingDateTime = 1557139189;//1529331799; //1528974697;//Mandatory
}
