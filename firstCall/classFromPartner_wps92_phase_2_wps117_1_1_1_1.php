...
class Input {
    ...
    public $customerId = 1541195; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    ...
    public $hotelIds = array (/*0 => 820415,*/934175); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1548633600; //Mandatory
    public $travelTo = 1548633600;//Mandatory
    public $bookingDateTime = 1543968000;//1529331799; //1528974697;//Mandatory
}
