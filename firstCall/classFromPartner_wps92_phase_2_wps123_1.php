...
class Input {
    ...
    public $customerId = 1534906111; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    public $environment = 'prod'; //string
    public $requestSource = 1; //integer
    public $exceptRestrictions = array(63345); //array integer No mandatory ,811555 804035
    public $passengerNationalityOrResidenceProvided = true; //boolean
    public $hotelIds = array (/*0 => 820415,*/1478108); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1548374400; //Mandatory
    public $travelTo = 1548374400;//Mandatory
    public $bookingDateTime = 1545220131;//1529331799; //1528974697;//Mandatory
}
