...
class Input {
    ...
    public $customerId = 1317255; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    ...
    public $hotelIds = array (0 => 7644); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1542672000; //Mandatory
    public $travelTo = 1542672000;//Mandatory
    public $bookingDateTime = 1539675406;//1529331799; //1528974697;//Mandatory
}
