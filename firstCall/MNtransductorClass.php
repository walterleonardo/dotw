...
class Check
{
    ...
    public function mandatoryTypeInput(&$data)
    {
        ...
        $types = array('customerId' => 'integer', 'environment' => 'string', 'requestSource' => 'integer','restReason' => 'array', 'passengerNationalityOrResidenceProvided' => 'boolean', 'hotelIds' => 'array', 'city' => 'integer', 'country' => 'integer','bookingChannelsWithAutoMapping' => 'array', 'excludedBookingchannel' => 'array', 'bookingChannelTypes' => 'array', 'RoomOccupancy' => 'array', 'HotelFilters' => 'object', 'RoomTypeFilters' => 'object', 'AdditionalFilters' => 'array','SearchPeriodCriteria' => 'object');
        $mandatory = array('customerId' => true, 'environment' => true, 'requestSource' => true,'restReason' => true, 'passengerNationalityOrResidenceProvided' => true, 'hotelIds' => false, 'city' => false, 'country' => false,'bookingChannelsWithAutoMapping' => false, 'excludedBookingchannel' => false, 'bookingChannelTypes' => false, 'RoomOccupancy' => true, 'HotelFilters' => false, 'RoomTypeFilters' => false, 'AdditionalFilters' => false, 'SearchPeriodCriteria' => true);
