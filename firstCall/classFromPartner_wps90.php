...
class Input {
    ...
    public $restReason = array(1,2,4,5,6); //array integer No mandatory
    public $passengerNationalityOrResidenceProvided = true; //boolean
    public $hotelIds = array (); //array(int)
    //country 143 and city 85516
    public $city = 175178; //364 dubai //12764; //7674; //integer 7674 // 13474 Zamora //12624 BUCHARESt //14 kuwait
