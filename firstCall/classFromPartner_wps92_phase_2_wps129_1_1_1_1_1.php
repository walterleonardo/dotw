...
class Input {
    ...
    public $customerId = 1432305;//1534906; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    ...
    public $hotelIds = array (188156/*0 => 820415,*/); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1565913600;//1553558400; //Mandatory
    public $travelTo = 1565913600;//Mandatory
    public $bookingDateTime = 1557239422;//1529331799; //1528974697;//Mandatory
}
 

class RoomOccupancy {
    public $adults = 4; //integer
    public $children = array (4); //array(int)
