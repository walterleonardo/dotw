...
class Input {
    ...
    public $hotelIds = array (/*0 => 820415,*/1622198); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1546041600; //Mandatory
    public $travelTo = 1546041600;//Mandatory
    public $bookingDateTime = 1544108012;//1529331799; //1528974697;//Mandatory
}
