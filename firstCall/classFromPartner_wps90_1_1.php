...
class Input {
    ...
    public $customerId = 1177708; //integer 1124718 84/12844 --- 1237928 CITY 12624 country 81
    public $environment = 'dev'; //string
    public $requestSource = 2; //integer
    public $exceptRestrictions = array(); //array integer No mandatory
    public $passengerNationalityOrResidenceProvided = true; //boolean
    public $hotelIds = array (); //array(int)
    //country 143 and city 85516
    public $city = 24119; //364 dubai //12764; //7674; //integer 7674 // 13474 Zamora //12624 BUCHARESt //14 kuwait
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1530057600; //Mandatory
    public $travelTo = 1530057600;//Mandatory
    public $bookingDateTime = 1528357080;//Mandatory
}
