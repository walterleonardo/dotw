...
class Input {
    ...
    public $hotelIds = array (/*0 => 820415,*/1512648); //array(int)
...
class  SearchPeriodCriteria{ //Mandatory
    public $travelFrom = 1546992000; //Mandatory
    public $travelTo = 1546992000;//Mandatory
    public $bookingDateTime = 1544098529;//1529331799; //1528974697;//Mandatory
}
